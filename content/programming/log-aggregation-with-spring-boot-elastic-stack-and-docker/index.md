...
- docker
- elasticsearch
summary: This post demonstrates how to use Elastic Stack along with Docker to collect, process, store, index and visualize logs of Spring Boot microservices.
aliases:
- /log-aggregation-with-spring-boot-elastic-stack-and-docker/
- /2019/06/30/log-aggregation-with-spring-boot-elastic-stack-and-docker/
---
...
### Enriching log events with tracing details

In a microservices architecture, a single business operation might trigger a chain of downstream microservice calls and such interactions between the services can be challenging to debug. To make things easier, we can use [Spring Cloud Sleuth][spring-cloud-sleuth] to enrich the application logs with tracing details. 
...
- To stop the containers, use `docker-compose down`. It's important to highlight that both Elasticsearch indices and the Filebeat tracking data are stored in the host, under the `./elasticseach/data` and `./filebeat/data` folders. It means that, if you destroy the containers, the data will be lost.
  ...
  [img.services]: images/diagram-services.png
  [img.elastic-stack]: images/diagram-elastic-stack.png
  [img.elastic-stack-docker]: images/diagram-services-and-elastic-stack.png
  [img.logstash-pipeline]: images/diagram-logstash-pipeline.png
  [img.screenshot-01]: images/screenshot-01.png
  [img.screenshot-02]: images/screenshot-02.png
  [img.screenshot-03]: images/screenshot-03.png
  [img.screenshot-04]: images/screenshot-04.png
  [img.screenshot-05]: images/screenshot-05.png
  [img.screenshot-06]: images/screenshot-06.png
  [img.screenshot-07]: images/screenshot-07.png
