...
- json
- jax-rs
summary: Using Jackson with JAX-RS? See how to define a ContextResolver for ObjectMapper to customize serialization and deserialization.
aliases:
- /2017/11/21/customizing-objectmapper-in-a-jaxrs-application/
---
