...
featured_image: "/assets/images/posts/log.jpg"
...
To stop the containers, use `docker-compose down`. It's important to highlight that both Elasticsearch indices and the Filebeat tracking data are stored in the host, under the `./elasticseach/data` and `./filebeat/data` folders. It means that, if you destroy the containers, the data will be lost.
  ...
  [img.elastic-stack-docker]: /assets/images/posts/log-aggregation/diagrams/services-and-elastic-stack.png
  [img.logstash-pipeline]: /assets/images/posts/log-aggregation/diagrams/logstash-pipeline.png
  [img.screenshot-01]: /assets/images/posts/log-aggregation/screenshots/01.png
  [img.screenshot-02]: /assets/images/posts/log-aggregation/screenshots/02.png
  [img.screenshot-03]: /assets/images/posts/log-aggregation/screenshots/03.png
  [img.screenshot-04]: /assets/images/posts/log-aggregation/screenshots/04.png
  [img.screenshot-05]: /assets/images/posts/log-aggregation/screenshots/05.png
  [img.screenshot-06]: /assets/images/posts/log-aggregation/screenshots/06.png
  [img.screenshot-07]: /assets/images/posts/log-aggregation/screenshots/07.png
