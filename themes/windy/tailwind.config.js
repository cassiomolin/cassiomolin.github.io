    ...
    typography: (theme) => ({
      ...
      DEFAULT: {
        css: {
          ...
          // Photography gallery
          '.photograph-gallery:has(+.photograph-gallery), .photograph-gallery:has(+.photograph), .photograph:has(+.photograph-gallery), .photograph:has(+.photograph)': {
            marginBottom: theme('spacing.4'),
          },
          '.photograph-gallery+.photograph-gallery, .photograph-gallery+.photograph, .photograph+.photograph-gallery,.photograph+.photograph': {
            marginTop: theme('spacing.4'),
          },
          '.photograph-gallery > .photograph': {
            marginTop: 0,
            marginBottom: 0,
          }
        },
